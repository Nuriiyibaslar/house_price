...
# grab_col_names fonksiyonu ile kategorik,karnidal ve sayisal degiskenler ayni zamanda sayisal gibi gorunen ama kategorik olan
# degiskenler yakalanacaktir.
# Not : Karnidal degisken kategorik olarak gorunen ama olcum degeri barindirmayan neredeyse gozlem birimi adedince olan degiskendir
...
# Bu fonk ile ilgili kategori degiskenlerin veri setindeki oranlarini analiz edebiliriz
...
# Bu fonk ile sayisal degiskenlerin betimsel istatistiklerinin analizini yapiyoruz
...
# 4. Hedef Değişken Analizi (Analysis of Target Variable)
# Kategorik degiskenlerin bagimli degisken ile birlikte analiz edilmesi
...
# Bağımlı değişkenin dagilimin incelenmesi
...
# Bu fonksiyon ile korelasyonu olan sayisal degiskenleri elde ediyoruz
...
# Elde ettigimiz korelasyonu yuksek degiskenleri drop_list olarak kaydettik
drop_list = high_correlated_cols(df, plot=False)


# Veri ön işleme işlemlerini gerçekleştiriniz.
...
# Eksik Değer Analizi
# Eksik degerlerin ilgili degiskenlerdeki orani
